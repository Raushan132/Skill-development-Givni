    ...
    return (
        <div className='w-full max-w-xs my-40 mx-auto'>
            <form className=' bg-red-100 shadow-xl rounded px-8 pt-6 pb-8 mb-4' onSubmit={handleAdd}>
                ...
                {/* <div className="mb-4">
                <label className='block text-gray-700 text-sm font-bold mb-2'>Submenu</label>
                <input type="text" id='submenu' value={data.submenu} onChange={handleData} className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline mb-4' placeholder='Enter data here' />
                </div> */}
